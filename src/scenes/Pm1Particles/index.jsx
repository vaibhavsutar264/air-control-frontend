...
const Pm1Particles = () => {
  ...
  const { data } = useGetPm1ParticlesQuery();
  ...
  return (
    <Box m="1.5rem 2.5rem">
      <Header title="PM 1.0 Particles in Air Readings Compared With Delhi, Mumbai and Kerala Location" subtitle="Chart of PM1.0 Particle vs Locations" />
      <Box height="5vh">
