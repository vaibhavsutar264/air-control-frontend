...
const Pm2_5Particles = () => {
  ...
  return (
    <Box m="1.5rem 2.5rem">
      <Header title="PM 2.5 Particles in Air Readings Compared With Delhi, Mumbai and Kerala Location" subtitle="Chart of PM2.5 Particle vs Locations" />
      <Box height="5vh">
